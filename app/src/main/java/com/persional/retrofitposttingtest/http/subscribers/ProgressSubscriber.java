package com.persional.retrofitposttingtest.http.subscribers;
...
/**
 * Created by tao on 2017/4/4.
 */

public class ProgressSubscriber<T extends ResultData> extends Subscriber<T> {
